...
public class SearchingAndSortingAlgorithms {
	...
	public void testFindString() throws Exception {
		...
		assertEquals(true, Algorithm.containsSOS(message1));
		List<String> message2 = Arrays
				.asList(".-- .. - .... / - .... . / .-.. .. --. .... - ... / --- ..- - --..-- / .. - .----. ... / .-.. . ... ... / -.. .- -. --. . .-. --- ..- ... / .... . .-. . / .-- . / .- .-. . / -. --- .-- ? / . -. - . .-. - .- .. -. / ..- ... / .. / ..-. . . .-.. / ... - ..- .--. .. -.. / .- -. -.. / -.-. --- -. - .- --. .. --- ..- ... / .... . .-. . / .-- . / .- .-. . / -. --- .-- ? / . -. - . .-. - .- .. -. / ..- ... / .- / -- ..- .-.. .- - - --- --..-- / .- -. / .- .-.. -... .. -. --- --..-- / .- / -- --- ... --.- ..- .. - --- --..-- / -- -.-- / .-.. .. -... .. -.. --- / -.-- . .- .... --..-- / .... . -.-- / -.-- . .- ....".split("/"));
		assertEquals(false, Algorithm.containsSOS(message2));
	}
	...
	public void testSort() throws Exception {
		...
		assertEquals(38.4, Algorithm.sortScores(results).get(0), 0.001);
		assertEquals(40.7, Algorithm.sortScores(results).get(1), 0.001);
		assertEquals(95.0, Algorithm.sortScores(results).get(13), 0.001);
	}
	...
	public void testSortStringLength() throws Exception {
		...
		assertEquals(sortedSequences, Algorithm.sortDNA(unsortedSequences));
	}
	...
	public void testSortStringContents() throws Exception {
		...
		assertEquals("aby", Algorithm.sortWords(words).get(0));
		assertEquals("bar", Algorithm.sortWords(words).get(10));
		assertEquals("daw", Algorithm.sortWords(words).get(words.size() - 1));
	}
